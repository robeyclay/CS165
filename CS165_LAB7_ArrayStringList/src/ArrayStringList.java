...
public class ArrayStringList {
    ...
    public void add(int index, String str) {
        String[] tempStrArr = new String[size + 1];
        int i = 0;
    ...
    public String get(int index) {
        //System.out.println("ASL: .get method() size " + size);
        if(index > -1 && index < size) {
            //System.out.println("ASL: .get method() data[index] " + data[index]);
            return data[index];
        } else {
            return null;
        }
    ...
    public void remove(int index) {
        String[] tempStrArr = new String[data.length];
        for(String p : data){
            System.out.println("ASL: before .remove() " + p);
        }
        int i = 0;
        ...
        for(String p : data){
            System.out.println("ASL: after .remove() " + p);
        }
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < list.size(); i ++){
            //System.out.println("ASL: print before .remove(1): should be alpha beta gamma " + list.get(i));
        }
        list.remove(1);
        referenceList.remove(1);
        for(int i = 0; i < list.size(); i ++){
            //System.out.println("ASL: print after .remove(1): should be beta gamma " + list.get(i));
        }
