...
public class Library {
    ...
    public static void main (String[] args) throws IOException {
        ...
        int linkedCounter = linkedListLibrary.insertSorted(currNode, linkedListOperations);
        ...
        //       the number of operations performed
        int arrayCounter = arrayListLibrary.insertSorted(tempBook, arrayListOperations);

        // TODO: Print number of operations for linked list
        System.out.println("Number of linked list operations: " + linkedCounter);
        // TODO: Print number of operations for ArrayList
        System.out.println("Number of ArrayList operations: " + arrayCounter);
