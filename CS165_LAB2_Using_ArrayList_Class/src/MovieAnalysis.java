...
public class MovieAnalysis {
    ...
    public Movie getHighestRated(){
        double highestRating = movies.get(0).getAverageRating();
        int indexHR = -1;
        for(int i = 0; i < movies.size(); i++)
        {
            if(movies.get(i).getAverageRating() > highestRating)
            {
                highestRating = movies.get(i).getAverageRating();
                indexHR = i;
            }
        }
        return movies.get(indexHR);
    }
    ...
    public Movie getLowestRated(){
        double lowestRating = movies.get(0).getAverageRating();
        int indexLR = -1;
        for(int i = 0; i < movies.size(); i++)
        {
            if(movies.get(i).getAverageRating() < lowestRating)
            {
                lowestRating = movies.get(i).getAverageRating();
                indexLR = i;
            }
        }
        return movies.get(indexLR);
    }
